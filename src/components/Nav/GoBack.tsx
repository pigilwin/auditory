...
export const GoBack = (): JSX.Element | null => {
    ...
    return (
        ...
        <a onClick={onClickHandler} className="block mt-4 lg:inline-block lg:mt-0 text-black cursor-pointer dark:text-white dark:hover:text-blue-100 hover:text-blue-100 text-lg text-center">
